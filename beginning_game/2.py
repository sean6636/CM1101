...
def normalise_input(user_input):
    nopunct = remove_spaces(remove_punct(user_input).lower()) 
    return nopunct
...
def print_menu_line(direction, leads_to):
    ...
    For example:
    >>> 
    Go EAST to you personal tutor's office.print_menu_line("east", "you personal tutor's office")
